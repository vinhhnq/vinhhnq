...
- 👀 Skills: - Frontend developer, data structure & algorithm(C++, python), liquid Shopify theme, a few knowledge data science with python pandas, tensorflow machine learning...
